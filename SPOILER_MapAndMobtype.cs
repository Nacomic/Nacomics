...
namespace Turbo.Plugins.Zy
{
    public class MapAndMobtype : BasePlugin, IInGameTopPainter, IKeyEventHandler
    {
        ...
        private List<MonsterSet> MonsterSetList = new List<MonsterSet>{
            new MonsterSet("쩔뚝이 광전사", new List<string>
            ...
            new MonsterSet("가시마귀 소환사", new List<string>
            ...
            new MonsterSet("핏빛 투창병", new List<string>
            ...
            new MonsterSet("왕거미", new List<string>
            ...
            new MonsterSet("거수", new List<string>
            ...
            new MonsterSet("육신", new List<string>
            ...
            new MonsterSet("휘갈이", new List<string>
            ...
            new MonsterSet("독감독(쩔뚝이 오리지날)", new List<string>
            ...
            new MonsterSet("라쿠니 위상수(역사)", new List<string>
            ...
            new MonsterSet("광신도 유령", new List<string>
            ...
            new MonsterSet("빨감", new List<string>
            ...
            new MonsterSet("저승 땅전갈", new List<string>
            ...
            new MonsterSet("한조 궁수", new List<string>
            ...
            new MonsterSet("구렁이뱀", new List<string>
            ...
            new MonsterSet("라돼지", new List<string>
            ...
            new MonsterSet("지옥개", new List<string>
            ...
            new MonsterSet("벌레떼", new List<string>
            ...
            new MonsterSet("혼란마", new List<string>
            ...
            new MonsterSet("조리퐁 쩔뚝이", new List<string>
            ...
            new MonsterSet("몰락자 영매", new List<string>
            ...
            new MonsterSet("철갑", new List<string>
