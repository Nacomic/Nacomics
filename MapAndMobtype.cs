...
namespace Turbo.Plugins.Zy
{
    public class MapAndMobtype : BasePlugin, IInGameTopPainter, IKeyEventHandler
    {
        ...
        private List<MonsterSet> MonsterSetList = new List<MonsterSet>{
            new MonsterSet("±¤Àü»çÂ¿¶ÒÀÌ", new List<string>
            ...
            new MonsterSet("°¡½Ã¸¶±Í¼ÒÈ¯¼ö", new List<string>
            ...
            new MonsterSet("°ñ°í·çÅõÃ¢º´", new List<string>
            ...
            new MonsterSet("¿Õ±×¹Ì", new List<string>
            ...
            new MonsterSet("°Å¼ö", new List<string>
            ...
            new MonsterSet("À°½Å", new List<string>
            ...
            new MonsterSet("ÈÖ°¥ÀÌ", new List<string>
            ...
            new MonsterSet("µ¶°¨", new List<string>
            ...
            new MonsterSet("¿ª»ç,À§»ó¼ö", new List<string>
            ...
            new MonsterSet("À¯·É¾ÆÁÜ¸¶", new List<string>
            ...
            new MonsterSet("»¡°¨", new List<string>
            ...
            new MonsterSet("¶¥Àü°¥", new List<string>
            ...
            new MonsterSet("»ç°Ý¼ö", new List<string>
            ...
            new MonsterSet("±¸··ÀÌ", new List<string>
            ...
            new MonsterSet("¶óµÅÁö", new List<string>
            ...
            new MonsterSet("Áö¿Á°³", new List<string>
            ...
            new MonsterSet("¹ú·¹¶¼", new List<string>
            ...
            new MonsterSet("È¥¶õ¸¶", new List<string>
            ...
            new MonsterSet("Â©°ñ", new List<string>
            ...
            new MonsterSet("¸ô¶ôÀÚ¿µ¸Å", new List<string>
            ...
            new MonsterSet("Ã¶°©", new List<string>
            ...
            new MonsterSet("Æø±º¿äºÎ", new List<string>
        ...
        private List<MapName> MapNameList = new List<MapName>{
            ...
            new MapName("¿µÀü!", new List<string>
            ...
            new MapName("ÆÄ¶õµ¿±¼", new List<string>
            ...
            new MapName("°¥»öµ¿±¼", new List<string>
            ...
            new MapName("´ë¼º´ç", new List<string>
            ...
            new MapName("ÅÂÃÊ", new List<string>
            ...
            new MapName("ÄÚ¸£ºÎ½º-_-", new List<string>
            ...
            new MapName("¾Æ¸®¾Ñ", new List<string>
            ...
            new MapName("¾ÏÀüÂª¸ð·¡", new List<string>
            ...
            new MapName("³ì»öµ¿±¼", new List<string>
            ...
            new MapName("ºñ¸í", new List<string>
            ...
            new MapName("Áö±Õ", new List<string>
            ...
            new MapName("¾óÀ½µ¿±¼", new List<string>
            ...
            new MapName("¼ºÃ¤", new List<string>
            {"a3dun_keep_s_entrance_01","a3dun_keep_ne_01","a3dun_keep_new_02","a3dun_keep_ns_02","a3dun_keep_s_exit_01","a3dun_keep_e_entrance_01","a3dun_keep_ew_02","a3dun_keep_sew_01","a3dun_keep_ne_02","a3dun_keep_w_exit_01",
             ...
             new MapName("¿ªº´±¼", new List<string>
            ...
            new MapName("¼ö·Î", new List<string>
            ...
            new MapName("Àå¸·", new List<string>
            {"p6_moor_ne_120_entrance_01","p6_moor_nse_01","p6_moor_nsw_01","p6_moor_border_elbow_sw_01","p6_moor_border_elbow_se_01","p6_moor_sew_01","p6_moor_ne_01", "p6_moor_se_01","p6_moor_border_elbow_nw_01","p6_moor_new_01",
             ...
             new MapName("¿µ°Ì", new List<string>
            ...
            new MapName("°öÃ¢", new List<string>
            ...
            new MapName("¾Æ¶ó³×", new List<string>
            ...
            new MapName("Ãµ»ó!", new List<string>
            ...
            new MapName("¼­ºÎ", new List<string>
            ...
            new MapName("¼­ºÎr", new List<string>
            ...
            new MapName("¾ÏÀü", new List<string>
        ...
        public override void Load(IController hud)
        {
            ...
            HotKey = Key.F11;
            Show = false;
            GreenFont = Hud.Render.CreateFont("tahoma", 8, 255, 0, 0, 125, true, false, 255, 255, 255, 255, true);
